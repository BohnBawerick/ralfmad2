...
program
  ...
  .option(
    "--platform <id>",
    "Target platform (claude-code, codex, cursor, windsurf, copilot, aider, gemini, ccr)"
  )
...
program
  ...
  .option("--driver <platform>", "Override platform driver (claude-code, codex, copilot, cursor, gemini, ccr)")
